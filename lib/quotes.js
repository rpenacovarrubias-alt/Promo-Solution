...
export async function createQuote({ customer, channel, items, notes } = {}) {
  ...
  if (!channel || !['TELEGRAM', 'WHATSAPP', 'FACEBOOK', 'INSTAGRAM', 'CHAT', 'EMAIL'].includes(channel))
    throw new QuoteValidationError('channel debe ser TELEGRAM, WHATSAPP, FACEBOOK, INSTAGRAM, CHAT o EMAIL')
