...
function GradientBackground({ stops }) {
  ...
  return e(
    Svg,
    { style: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0 }, viewBox: '0 0 100 100', preserveAspectRatio: 'none' },
    ...Array.from({ length: GRADIENT_BANDS }, (_, i) => {
      const t0 = (i / GRADIENT_BANDS) * 100
      const t1 = ((i + 1) / GRADIENT_BANDS) * 100
